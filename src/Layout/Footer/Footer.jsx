export default function Footer() {
  return (
    <div className="w-screen flex flex-col gap-3 px-3 py-10 bg-slate-500 md:px-10">
        <h6 className="text-white flex items-center md:text-2xl">Theme by Colorlib Powered by WordPress</h6>
