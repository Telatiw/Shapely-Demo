...
function PralexContent() {
    ...
    return (
        <div className="relative">
            <div>
                <div className="bg-cover bg-center bg-[url('/SParalexSection.jpg')] h-250 -z-10 w-screen absolute  " ref={ref}></div>
            </div>
            <div className=" px-5 py-10 flex flex-col items-center gap-5 justify-evenly md:px-40">
                <h5 className="text-2xl text-center text-primary-content md:text-5xl">Small Parallax Section</h5>
